...
- Prevents mobile auto-focus from opening the keyboard when entering message edit mode, opening the chat file manager, or entering a character chat while preserving manual input focus
